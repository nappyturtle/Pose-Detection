...
public interface IEnrollmentService {
    ...
    @GET("enrollment/getAllTrainerOfBoughtCourse")
    Call<List<Account>> getAllTrainerOfBoughtCourse(@Header(Constants.header_string) String token, @Query("accountId") int accountId);
