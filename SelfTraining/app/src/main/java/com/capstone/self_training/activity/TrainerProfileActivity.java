...
public class TrainerProfileActivity extends AppCompatActivity {
    ...
    private void reflect() {
        ...
        imgAccount = (ImageView) findViewById(R.id.img_trainer_profile_id);
    ...
    private void transferUploadVideo() {
        uploadVideo.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent i = new Intent(TrainerProfileActivity.this, TrainerUploadVideoActi.class);
                startActivity(i);
            }
        });
    }
