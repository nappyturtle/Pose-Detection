...
import com.example.pdst.Adapter.RelateVideoAdapter;
import com.example.pdst.Model.Account;
...
public class PlayVideoActivity extends AppCompatActivity implements SurfaceHolder.Callback,
    ...
    TextView video_title,video_view,username,user_sub;
    CircleImageView user_img;
    Button next_video_btn, user_sub_btn;
    ...
    private static final Account account_demo = new Account(
            1,
            "hoangtlt",
            "acbxyz123",
            "hoang@gmail.com",
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        if(isFullScreen() == false){
            ...
            video_view.setText(TransformDataUtil.totalViewToText(playingVideo.getNum_of_view()));
            username.setText(playingVideo.getAccount().getUsername());
            ...
            Picasso.get().load(playingVideo.getAccount().getImg_url()).fit().into(user_img);
        ...
        String videoPath =  playingVideo.getContent_url();
