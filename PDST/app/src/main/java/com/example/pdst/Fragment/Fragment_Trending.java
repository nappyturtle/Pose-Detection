...
package com.example.pdst.Fragment;
...
import com.example.pdst.Activity.MainActivity;
import com.example.pdst.Adapter.HomeVideoAdapter;
    ...
    public View onCreateView(@NonNull LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        ...
        for (int i = 0; i < 10; i++) {
            Video video = new Video(
                    1,
                    "Demo display long name video about yoga thumbnail in list " + (9-i),
                    thumbnail_list_demo[(9-i)],
                    video_list_demo[(9-i)],
                    account_demo,
                    null,
                    10134,
        ...
        trendingVideoAdapter = new HomeVideoAdapter(videos, getContext());
