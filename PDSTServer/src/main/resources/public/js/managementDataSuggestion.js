...
// }
//
// function getSuggestionListData() {
...
//             var propertiesRes = ['id', 'videoname', 'accountname', 'thumnailUrl', 'status', '']; // changed this
//             // list tên các th
//             var propertiesTemp = ['Stt', 'Tên video', 'Tên học viên', 'Ảnh đại diên', 'Trạng thái', '']; // changed this
//
...
//                         button.setAttribute('onclick', "editStatusSuggestion('myCheck" + jsonResponse[r].id + "')");
...
//                             td.appendChild(input);
//                         } else if (propertiesRes[i] == "thumnailUrl") {
...
//         }
//     };
//     xhttp.open("GET", "/suggestion/getAllSuggestionByStaffOrAdmin", true);
//     //xhttp.responseType = "json";
//     xhttp.setRequestHeader("Authorization", token);
//     xhttp.send();
// }
//
// function editStatusSuggestion(myCheck) {
//     console.log(myCheck);
...
$(document).ready(function () {
    ...
    if (currentStaff != undefined) {
        if (currentStaff.roleId == 1 || currentStaff == 2) {
            ...
            $('#tblSuggestion').on('click', 'tbody .btn-edit', function (e) {
