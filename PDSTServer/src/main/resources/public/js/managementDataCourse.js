...
//             var propertiesRes = ['id', 'coursename', 'categoryname', 'accountname', 'price', 'thumbnail', 'status', '']; // changed this
//             // list tên các th
//             var propertiesTemp = ['Stt', 'Tên khóa học', 'Danh mục', 'Huấn luyện viên', 'Giá', 'Ảnh đại diên', 'Trạng thái', '']; // changed this
//
...
//                         button.setAttribute('onclick', "editStatusCourse('myCheck" + jsonResponse[r].id + "')");
...
//                             td.appendChild(input);
//                         } else if (propertiesRes[i] == "thumbnail") {
...
//         }
//     };
//     xhttp.open("GET", "/course/getAllCourseByStaffOrAdmin", true);
//     //xhttp.responseType = "json";
//     xhttp.setRequestHeader("Authorization", token);
//     xhttp.send();
// }
//
// function editStatusCourse(myCheck) {
//     console.log(myCheck);
...
$(document).ready(function () {
    ...
    if (currentStaff != undefined) {
        if (currentStaff.roleId == 1 || currentStaff == 2) {
            ...
            $('#tblCourse').on('click', 'tbody .btn-edit', function (e) {
