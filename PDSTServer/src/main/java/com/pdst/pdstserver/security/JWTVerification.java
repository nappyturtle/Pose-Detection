...
public class JWTVerification extends BasicAuthenticationFilter {

    public JWTVerification(AuthenticationManager authenticationManager) {
    ...
    private UsernamePasswordAuthenticationToken getAuthenticationToken(HttpServletRequest request) {
        ...
        if (tokenHeader != null) {
            ...
            if (username != null) {
                Collection<GrantedAuthority> authorities = Arrays.stream(getDecodedJWT(token)
